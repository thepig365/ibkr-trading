...
M: dict[str, dict[str, str]] = {
    ...
    "trades.execution_timeline": {"en": "Execution timeline", "zh": "时间线"},
    ...
    "trades.sec_entry_exit": {"en": "2 · Entry / exit", "zh": "2 · 入场与平仓"},
    "trades.sec_risk": {"en": "3 · Risk plan", "zh": "3 · 风险计划"},
    "trades.sec_engine": {"en": "4 · Engine decision", "zh": "4 · 引擎决策"},
    "trades.sec_ict": {"en": "5 · ICT labels", "zh": "5 · ICT 标签"},
    "trades.sec_protection": {"en": "6 · Protection / orders", "zh": "6 · 括号保护"},
    "trades.sec_chart": {"en": "7 · Trade chart", "zh": "7 · 交易图表"},
    "trades.sec_raw": {"en": "8 · Raw audit (collapsed)", "zh": "8 · 原始审计（折叠）"},
